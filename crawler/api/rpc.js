...
exports.getVcpByHeight = function (params, callback) {
  body = {
    jsonrpc: '2.0',
    method: 'dnero.GetVcpByHeight',
    params: params,
    id: RandomIdGenerator()
  }
  ProcessHttpRequest(config.node.address, config.node.port, 'POST', '/rpc', JSON.stringify(body), callback);
}
exports.getScpByHeight = function (params, callback) {
  body = {
    jsonrpc: '2.0',
    method: 'dnero.GetScpByHeight',
    params: params,
    id: RandomIdGenerator()
  }
  ProcessHttpRequest(config.node.address, config.node.port, 'POST', '/rpc', JSON.stringify(body), callback);
...
exports.GetValidatorSetByHeight = function (params, callback) {
  body = {
    jsonrpc: '2.0',
    method: 'dnero.GetValidatorSetByHeight',
    params: params,
    id: RandomIdGenerator()
  }
  ProcessHttpRequest(config.node.address, config.node.port, 'POST', '/rpc', JSON.stringify(body), callback);
...
exports.getPendingTxs = function (params, callback) {
  body = {
    jsonrpc: '2.0',
    method: 'dnero.GetPendingTransactions',
    params: params,
    id: RandomIdGenerator()
  }
  ProcessHttpRequest(config.node.address, config.node.port, 'POST', '/rpc', JSON.stringify(body), callback);
...
exports.getStakeRewardDistribution = function (params, callback) {
  body = {
    jsonrpc: '2.0',
    method: 'dnero.GetStakeRewardDistributionByHeight',
    params: params,
    id: RandomIdGenerator()
  }
  ProcessHttpRequest(config.node.address, config.node.port, 'POST', '/rpc', JSON.stringify(body), callback);
