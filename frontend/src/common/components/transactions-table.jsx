  ...
  return (
    <React.Fragment>
      <div className="currency dnero">
        {formatCoin(coins.dnerowei)}
        {!isMobile && "Dnero"}
        {!isMobile && <div className='price'>{`[\$${priceCoin(coins.dnerowei, price['Dnero'])} USD]`}</div>}
      </div>
      <div className="currency dtoken">
        {formatCoin(coins.dtokenwei)}
        {!isMobile && "DToken"}
        {!isMobile && <div className='price'>{`[\$${priceCoin(coins.dtokenwei, price['DToken'])} USD]`}</div>}
      </div>
    </React.Fragment>)
}
