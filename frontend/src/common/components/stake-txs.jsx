...
const TRUNC = 2;
const TitleMap = {
  'dnero_source': 'DNERO TOKENS STAKED BY THIS ADDRESS TO VALIDATOR/GUARDIAN NODES',
  'dnero_holder': 'DNERO TOKENS STAKED TO THIS NODE',
  'dtoken_source': 'DTOKEN TOKENS STAKED BY THIS ADDRESS TO ELITE EDGE NODES',
  'dtoken_holder': 'DTOKEN TOKENS STAKED TO THIS NODE'
}
...
export default class StakeTxsTable extends React.PureComponent {
  ...
  render() {
    ...
    const currencyUnit = stakeCoinType === 'dtoken' ? 'dtokenwei' : 'dnerowei';
    const currency = stakeCoinType === 'dtoken' ? 'DToken' : 'Dnero';
    return (
