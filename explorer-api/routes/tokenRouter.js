...
var tokenRouter = (app, tokenDao, tokenSumDao, tokenHolderDao, config) => {
  ...
  router.get("/token/topholders", (req, res) => {
    ...
    let { limit = 100, tokenId, token = 'ddrop' } = req.query;
    limit = Number(limit);
    if (limit > 100) limit = 100;
    if (token !== 'ddrop' && token !== 'lavita') {
      res.status(400).send({ type: 'invalid_token_name' });
      return;
    }
    //testnet
    // const tokenAddress = token === 'ddrop' ? "0x08a0c0e8efd07a98db11d79165063b6bc2469adf" : "0x46fbf4487fa1b9c70d35bd761c51c360df9459ed"
    //mainnet
    const tokenAddress = token === 'ddrop' ? "0x1336739b05c7ab8a526d40dcc0d04a826b5f8b03" : "0x46fbf4487fa1b9c70d35bd761c51c360df9459ed"
